create or replace table FL_lookup
(sr_no int,
table_name varchar,
query varchar,
active varchar);
...
insert into FL_lookup values(1,'ADMINS','INSERT OVERWRITE INTO ADMINS 
select 
...
insert into FL_lookup values(2,'MASTERCLIENTS','INSERT OVERWRITE INTO MASTERCLIENTS
select 
data:_id::VARIANT,
...
insert into FL_lookup values(3,'BATCHES','INSERT OVERWRITE INTO BATCHES
...
insert into FL_lookup values(4,'PRODUCTS','INSERT OVERWRITE INTO PRODUCTS
SELECT 
	DATA:_id::VARIANT ,
...
insert into FL_lookup values(5,'SUBCLIENTS','INSERT OVERWRITE INTO SUBCLIENTS
SELECT 
DATA:_id ::VARIANT,
DATA:blockingHistory::ARRAY,
DATA:createdByType::VARCHAR,
...
insert into FL_lookup values(6,'ONETIMECLIENTS','INSERT OVERWRITE INTO OneTimeClients
...
insert into FL_lookup values(7,'CUSTOMERS','INSERT OVERWRITE INTO customers
...
insert into FL_lookup values(8,'TYPEONECOUPONSETS','insert overwrite into typeonecouponsets
...
insert into FL_lookup values(9,'TYPEONECOUPONCODES','insert overwrite into typeonecouponcodes
select 
    data:_id::VARIANT,
...
insert into FL_lookup values(10,'DORS','INSERT OVERWRITE INTO DORS 
select 
...
insert into FL_lookup values(11,'TORS','INSERT OVERWRITE INTO TORS 
select 
...
','Y');
  ...
  insert into FL_lookup values(12,'VECTORTABLE4_1','INSERT OVERWRITE INTO VECTORTABLE4_1
select 
  data : _id :: VARIANT _id,
...
insert into FL_lookup values(13,'VECTORTABLE4_2','INSERT OVERWRITE INTO VECTORTABLE4_2
select 
...
insert into FL_lookup values(14,'VECTORTABLE6','INSERT OVERWRITE INTO VECTORTABLE6
select 
  data : _id :: VARIANT _id,
...
insert into FL_lookup values(15,'VECTORTABLE7','INSERT OVERWRITE INTO VECTORTABLE7
select 
...
insert into FL_lookup values(16,'VECTORTABLE8','INSERT OVERWRITE INTO VECTORTABLE8
select 
  data : _id :: VARIANT _id,
  data : createdAt :: TIMESTAMP_NTZ  createdAt,
  data : qrId :: VARCHAR qrId,
...
from 
  ...
  insert into FL_lookup values(17,'VECTORTABLE9','INSERT OVERWRITE INTO VECTORTABLE9
select 
  data : _id :: VARIANT _id,
  data : createdAt :: TIMESTAMP_NTZ  createdAt,
  data : qrId :: VARCHAR qrId,

##Created By Mudit For loading MongoDB collections Data into S3
...
def log_job_status(job_id, start_time, end_time, status, error_message=None):
    ...
    query = f"INSERT INTO ANALYTICS.GLUE_JOB_LOGS VALUES ('{job_id}','{start_time}','{end_time}','{status}','{error_message}')"

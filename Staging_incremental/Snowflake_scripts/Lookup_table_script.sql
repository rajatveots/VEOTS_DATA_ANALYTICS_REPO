create or replace table incremental_lookup
(sr_no int,
table_name varchar,
query varchar,
active varchar);
...
insert into incremental_lookup values(1,'ADMINS','INSERT  INTO ADMINS 
select 
...
insert into incremental_lookup values(2,'MASTERCLIENTS','INSERT  INTO MASTERCLIENTS
select 
data:_id::VARIANT,
...
insert into incremental_lookup values(3,'BATCHES','INSERT  INTO BATCHES
...
insert into incremental_lookup values(4,'PRODUCTS','INSERT  INTO PRODUCTS
SELECT 
	DATA:_id::VARIANT ,
...
insert into incremental_lookup values(5,'SUBCLIENTS','INSERT  INTO SUBCLIENTS
SELECT 
DATA:_id ::VARIANT,
DATA:blockingHistory::ARRAY,
DATA:createdByType::VARCHAR,
...
insert into incremental_lookup values(6,'ONETIMECLIENTS','INSERT  INTO OneTimeClients
...
insert into incremental_lookup values(7,'CUSTOMERS','INSERT  INTO customers
...
insert into incremental_lookup values(8,'TYPEONECOUPONSETS','insert  into typeonecouponsets
...
insert into incremental_lookup values(9,'TYPEONECOUPONCODES','insert  into typeonecouponcodes
select 
    data:_id::VARIANT,
...
insert into incremental_lookup values(10,'DORS','INSERT  INTO DORS 
select 
...
insert into incremental_lookup values(11,'TORS','INSERT  INTO TORS 
select 
...
','Y');
  ...
  insert into incremental_lookup values(12,'VECTORTABLE4_1','INSERT  INTO VECTORTABLE4_1
select 
  data : _id :: VARIANT _id,
...
insert into incremental_lookup values(13,'VECTORTABLE4_2','INSERT  INTO VECTORTABLE4_2
select 
...
insert into incremental_lookup values(14,'VECTORTABLE6','INSERT  INTO VECTORTABLE6
select 
  data : _id :: VARIANT _id,
...
insert into incremental_lookup values(15,'VECTORTABLE7','INSERT  INTO VECTORTABLE7
select 
...
insert into incremental_lookup values(16,'VECTORTABLE8','INSERT  INTO VECTORTABLE8
select 
  data : _id :: VARIANT _id,
  data : createdAt :: TIMESTAMP_NTZ  createdAt,
  data : qrId :: VARCHAR qrId,
...
from 
  ...
  insert into incremental_lookup values(17,'VECTORTABLE9','INSERT  INTO VECTORTABLE9
select 
  data : _id :: VARIANT _id,
  data : createdAt :: TIMESTAMP_NTZ  createdAt,
  data : qrId :: VARCHAR qrId,

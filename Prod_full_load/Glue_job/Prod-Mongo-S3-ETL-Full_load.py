...
args = getResolvedOptions(sys.argv,['db','bucket','mongo_uri','excluded_clients','sfURL','sfRole','sfUser','sfPassword','sfDatabase','sfSchema','sfWarehouse', 'JOB_NAME'])
db_name =args['db']
...
def log_job_status(job_id, start_time, end_time, status, error_message=None):
    ...
    query = f"INSERT INTO ANALYTICS.FL_GLUE_JOB_LOGS VALUES ('{job_id}','{start_time}','{end_time}','{status}','{error_message}')"
